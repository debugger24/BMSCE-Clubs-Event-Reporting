    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Title -->
                <h1 class="mt-4" id="eventTitle">Post Title</h1>

                <!-- Club Name -->
                <p class="lead" id="eventClub">by<a href="#"> Club Name</a></p>
                <hr>

                <!-- Date/Time -->
                <p id="eventPostDate">Posted on January 1, 2017 at 12:00 PM</p>
                <hr>
